...
CREATE TABLE IF NOT EXISTS person (
    ...
    CONSTRAINT person_client_id_fk FOREIGN KEY (client_id) REFERENCES client (client_id) ON DELETE CASCADE,
    CONSTRAINT person_created_by_fk FOREIGN KEY (created_by) REFERENCES user_account (user_account_id),
    CONSTRAINT person_updated_by_fk FOREIGN KEY (updated_by) REFERENCES user_account (user_account_id),
